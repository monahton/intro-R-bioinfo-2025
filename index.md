...
humandate: "November 11 - November 14, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
collaborative_notes: https://etherpad.wikimedia.org/p/intro-R-bioinfo-2025 # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
eventbrite:    1782204023209       # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
